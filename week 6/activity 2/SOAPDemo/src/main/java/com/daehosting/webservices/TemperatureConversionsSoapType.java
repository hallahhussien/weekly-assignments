...
public interface TemperatureConversionsSoapType {
    ...
    @RequestWrapper(localName = "CelsiusToFahrenheit", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.CelsiusToFahrenheit")
    @ResponseWrapper(localName = "CelsiusToFahrenheitResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.CelsiusToFahrenheitResponse")
    ...
    @RequestWrapper(localName = "FahrenheitToCelsius", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.FahrenheitToCelsius")
    @ResponseWrapper(localName = "FahrenheitToCelsiusResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.FahrenheitToCelsiusResponse")
    ...
    @RequestWrapper(localName = "WindChillInCelsius", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.WindChillInCelsius")
    @ResponseWrapper(localName = "WindChillInCelsiusResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.WindChillInCelsiusResponse")
    ...
    @RequestWrapper(localName = "WindChillInFahrenheit", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.WindChillInFahrenheit")
    @ResponseWrapper(localName = "WindChillInFahrenheitResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "com.daehosting.webservices.WindChillInFahrenheitResponse")
